...
/*
 * Localization switch for TouchDraw.
 *
 ...
 */
    ...
    #define L10N_PLUGIN_NAME            "F's TouchDraw"
    #define L10N_PLUGIN_DESC            "绘制集中线"
    #define L10N_PARAM_RANDOM_SEED      "随机种子"
    #define L10N_PARAM_VALUE            "数量"
    #define L10N_PARAM_TARGET           "设置"
    #define L10N_PARAM_MODE             "生成模式"
    #define L10N_PARAM_MODE_ITEMS       "目标颜色|亮度|Alpha"
    #define L10N_PARAM_TARGET_COLOR     "目标颜色"
    #define L10N_PARAM_COLOR_RANGE      "目标颜色阈值"
    #define L10N_PARAM_DELTA_RANGE      "亮度阈值"
