...
/*
 * Localization switch for sputteringAlpha.
 *
 ...
 */
    ...
    #define L10N_PLUGIN_NAME            "F's sputteringAlpha"
    #define L10N_PLUGIN_DESC            "在不透明区域和Alpha边界线上喷溅像素点"
    #define L10N_PARAM_SEED                 "随机种子"
    #define L10N_PARAM_VALUE                "数量(%)"
    #define L10N_PARAM_EDGE_VALUE           "边缘数量(%)"
...
#else
    #define L10N_PLUGIN_NAME            "F's sputteringAlpha"
    #define L10N_PLUGIN_DESC            "アルファーの境界線上にスパッタリング"
