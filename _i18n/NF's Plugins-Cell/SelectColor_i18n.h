 ...
 */
    ...
    #define L10N_PARAM_TARGET0          "目标方案0"
    #define L10N_PARAM_TARGET1          "目标方案1"
    #define L10N_PARAM_TARGET2          "目标方案2"
    #define L10N_PARAM_TARGET3          "目标方案3"
    #define L10N_PARAM_TARGET4          "目标方案4"
    #define L10N_PARAM_TARGET5          "目标方案5"
    #define L10N_PARAM_TARGET6          "目标方案6"
    #define L10N_PARAM_TARGET7          "目标方案7"
    #define L10N_PARAM_ENABLE           "开"
