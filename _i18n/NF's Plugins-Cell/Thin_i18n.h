 ...
 */
    ...
    #define L10N_PARAM_ENABLED_COLOR1   "收缩方案1"
    #define L10N_PARAM_ENABLED_COLOR2   "收缩方案2"
    #define L10N_PARAM_ENABLED_COLOR3   "收缩方案3"
    #define L10N_PARAM_ENABLED_COLOR4   "收缩方案4"
