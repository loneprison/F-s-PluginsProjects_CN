...
/*
 * Localization switch for NoiseHiLo_Alpha.
 *
 ...
 */
    ...
    #define L10N_PLUGIN_NAME            "F's NoiseHiLo_Alpha"
    #define L10N_PLUGIN_DESC            "按Alpha通道亮/暗区域分别添加噪声的滤镜"
...
#else
    #define L10N_PLUGIN_NAME            "F's NoiseHiLo_Alpha"
    #define L10N_PLUGIN_DESC            "アルファーチャンネルの明るい・暗いところ別にノイズを加えるフィルタ"
