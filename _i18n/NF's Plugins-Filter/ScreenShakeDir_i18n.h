...
/*
 * Localization switch for ScreenShakeDir.
 *
 ...
 */
    ...
    #define L10N_PLUGIN_NAME            "F's ScreenShakeDir"
    #define L10N_PLUGIN_DESC            "动画风格屏幕抖动，带方向指示版"
    #define L10N_PARAM_AMOUNT_PX        "幅度 (像素)"
...
#else
    #define L10N_PLUGIN_NAME            "F's ScreenShakeDir"
    #define L10N_PLUGIN_DESC            "アニメちっく画面動。方向指示バージョン"
