...
#include "Fs_Target.h"
#include "MainLineRepaintText.generated.h"
	...
	PF_LayerDef		*output )
{
	...
	CFsAE ae;
	const MainLineRepaintText::Strings strings(in_data);
	...
	try
	{
		...
		switch (cmd) {
			...
			case PF_Cmd_DO_DIALOG: {
				...
				MainLineRepaintText::OpenSettings(in_data, L"F's MainLineRepaint");
				break;		
			}
