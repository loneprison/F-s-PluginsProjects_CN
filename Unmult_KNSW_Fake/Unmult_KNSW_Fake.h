...
#include "Unmult_KNSW_FakeText.generated.h"
...
//-------------------------------------------------------
class Unmult_KNSW_Fake : public AEInfo
{
public:
	// ******************************************************
		...
		PF_LayerDef* outputP) override
	{
		...
		const Unmult_KNSW_FakeText::Strings strings(in_dataP);
	...
	
	{
		...
		try
		{
			...
			case PF_Cmd_DO_DIALOG: {
				...
				Unmult_KNSW_FakeText::OpenSettings(in_dataP, L"F's Unmult_KNSW_Fake");
				break;
			}
