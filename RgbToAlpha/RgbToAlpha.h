...
#define STR_POP1	L10N_PARAM_FILL_COLOR
#define STR_POP2	L10N_PARAM_FILL_ITEMS
#define STR_POP		3
#define STR_POP_DEF	1

#define STR_COLOR	L10N_PARAM_CUSTOM_COLOR
#define STR_REV1	L10N_PARAM_REVERSE_ALPHA
#define STR_REV2	L10N_PARAM_REV
