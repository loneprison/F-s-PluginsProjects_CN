...
#pragma once
#ifndef ColorChangeEng_H
#define ColorChangeEng_H
...
#define ID_TARGET(IDX) (ID_TARGET0 + (IDX)*3)
...
typedef struct ParamInfo{
	...
	A_u_char		Lv;
	A_long			count;
	PF_Pixel		Src[ColorChangeEngCount];
	PF_Pixel		Dst[ColorChangeEngCount];
	PF_Pixel16		Dst16[ColorChangeEngCount];
	PF_PixelFloat	Dst32[ColorChangeEngCount];
