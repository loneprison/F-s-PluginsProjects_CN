...
#include "Fs_Target.h"
#include "whiteInOutText.generated.h"
	...
	PF_LayerDef		*output )
{
	...
	CFsAE ae;
	const whiteInOutText::Strings strings(in_data);
	...
	try
	{
		...
		switch (cmd) {
			...
			case PF_Cmd_DO_DIALOG: {
				...
				whiteInOutText::OpenSettings(in_data, L"F's whiteInOut");
				break;
			}
