    ...
    FloatType maxChan)
{
    ...
    if (radius >= w) {
        ...
        FloatType maaxV = static_cast<FloatType>((((FloatType)maax.red * 0.299) + ((FloatType)maax.green * 0.587) + ((FloatType)maax.blue * 0.114))*10 + (FloatType)maax.alpha /maxChan);

        for (A_long x = 1; x < w; x++) {
            FloatType v = static_cast<FloatType>((((FloatType)outP[x].red * 0.299) + ((FloatType)outP[x].green * 0.587) + ((FloatType)outP[x].blue * 0.114))*10 + (FloatType)outP[x].alpha/maxChan);
    ...
    for (A_long i = 0; i < w; i++) {
        ...
        line[i] = outP[i];
        lineLevel[i] = static_cast<FloatType>((((FloatType)line[i].red * 0.299) + ((FloatType)line[i].green * 0.587) + ((FloatType)line[i].blue * 0.114))*10 + (FloatType)line[i].alpha/maxChan);
    }
    ...
    FloatType maxChan)
{
    ...
    if (radius >= w) {
        ...
        FloatType miinV = static_cast<FloatType>((((FloatType)miin.red * 0.299) + ((FloatType)miin.green * 0.587) + ((FloatType)miin.blue * 0.114))*10 + (FloatType)miin.alpha/maxChan);
    ...
    FloatType maxChan)
{
    ...
    if (radius >= h) {
        ...
        for (A_long y = 1; y < h; y++) {
            ...
            FloatType v = static_cast<FloatType>((((FloatType)p->red * 0.299) + ((FloatType)p->green * 0.587) + ((FloatType)p->blue * 0.114)) + (FloatType)p->alpha / maxChan);
    ...
    for (A_long y = 0; y < h; y++) {
        ...
        lineLevel[y] = static_cast<FloatType>((((FloatType)line[y].red * 0.299) + ((FloatType)line[y].green * 0.587) + ((FloatType)line[y].blue * 0.114)) + (FloatType)line[y].alpha/maxChan);
    }
    ...
    FloatType maxChan)
{
    ...
    if (radius >= h) {
        ...
        for (A_long y = 1; y < h; y++) {
            PixelType* p = (PixelType*)infoP->world->data + (y * wt + x);
            FloatType v = static_cast<FloatType>((((FloatType)p->red * 0.299) + ((FloatType)p->green * 0.587) + ((FloatType)p->blue * 0.114))*10 + (FloatType)p->alpha/maxChan);
    ...
    for (A_long y = 0; y < h; y++) {
        line[y] = *((PixelType*)infoP->world->data + (y * wt + x));
        lineLevel[y] = static_cast<FloatType>((((FloatType)line[y].red * 0.299) + ((FloatType)line[y].green * 0.587) + ((FloatType)line[y].blue * 0.114))*10 + (FloatType)line[y].alpha/maxChan);
    }
