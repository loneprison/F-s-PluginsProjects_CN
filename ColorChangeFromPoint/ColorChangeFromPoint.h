//-----------------------------------------------------------------------------------
/*
	ColorChangeFromPoint for VS2010
*/
//-----------------------------------------------------------------------------------

#pragma once
#ifndef ColorChangeFromPointMain_H
#define ColorChangeFromPointMain_H
...
enum {
	MODE_NONE = 0,	// no exec
	MODE_NORMAL,	// exec
	MODE_ALPHA_ZERO	// alpha Zero
};


//UIのパラメータ
typedef struct ParamInfo {
	// Target Pixel Point Integer
	A_long			pointX;
	A_long			pointY;
...
//-------------------------------------------------------
class ColorChangeFromPoint : public AEInfo
{
public:
	// ******************************************************
